...
import 'package:flutter_catalogue/widgets/icon_text_widget.dart';
          ...
          Row(
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(color: Colors.white, borderRadius: BorderRadius.circular(AppLayout.getHeight(20)), boxShadow: [
                  BoxShadow(
                ...
                child: Column(children: [
                  ...
                  Text("20% discount on the early booking of this flight. Don't miss out", style: Styles.headLineStyle2,)
                ]),
              ),
              Column(
                children: [
                  Stack(
                    ...
                    decoration: BoxDecoration(color: Color(0xFF3AB8B8), borderRadius: BorderRadius.circular(AppLayout.getHeight(18))),
                    padding: EdgeInsets.symmetric(vertical: AppLayout.getHeight(15), horizontal: AppLayout.getHeight(15)),
